...
if (isset($data['email'], $data['username'])) {
    ...
    if (filter_var($email, FILTER_VALIDATE_EMAIL)) {
        $subject = "Your Order is Ready to Pickup - Rimberio Cafe";
        ...
        <html>
            ...
            <body>
                ...
                <div class='email-body'>
                    We are delighted to inform you that your order is now Available and Ready to Pickup.
                    <br><br>
        ...
        try {
            ...
            $mail->send();
            $response = ['status' => 'success', 'message' => 'Ready to Pickup Notification sent successfully.'];
        } catch (Exception $e) {
